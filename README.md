...
### Updates
v0.5 (2017-04-26): Now accomodates Arabic, Chinese, Haitian Creole, French, Russian, and Spanish, as well as English, but currently this must be passed via commandline using the language's three-character ISO code, e.g.:
```
